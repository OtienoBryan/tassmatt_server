...
async function testProductUpdateDirect() {
  ...
  try {
    console.log('Testing direct product update with brand and brandId...');
    ...
    console.log(`Before - brand: "${product.brand}", brandId: ${product.brandId}`);
    ...
    console.log(`After - brand: "${updated.brand}", brandId: ${updated.brandId}`);
    ...
    console.error('❌ Error testing direct update:', error);
  } finally {
    await connection.end();
  }
}

testProductUpdateDirect();
